...
class MU_07_ROR_07_FALSETest {
    @DisplayName("MU_07_ROR_07_FALSE")
    ...
    public void removeFromArrayTest(int inputArray[], int inputInteger, int expectedOutputArray[]){
        Assertions.assertArrayEquals(expectedOutputArray, MU_07_ROR_07_FALSE.deleteAllVal(inputArray,inputInteger));
    }
}